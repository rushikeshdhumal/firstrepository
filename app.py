...
image = Image.open('/content/Naive-Resume-Matching/Images/logo.png')
...
Resumes = pd.read_csv('/content/Naive-Resume-Matching/Resume_Data.csv')
Jobs = pd.read_csv('/content/Naive-Resume-Matching/Job_Data.csv')
